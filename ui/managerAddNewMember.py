...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.line_dLeader = QtWidgets.QLineEdit(self.verticalLayoutWidget)
        self.line_dLeader.setObjectName("line_dLeader")
        self.fLayout_addNewMember.setWidget(6, QtWidgets.QFormLayout.FieldRole, self.line_dLeader)
