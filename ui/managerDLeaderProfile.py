...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        spacerItem5 = QtWidgets.QSpacerItem(160, 20, QtWidgets.QSizePolicy.Maximum, QtWidgets.QSizePolicy.Minimum)
        ...
        self.btn_addMember = QtWidgets.QPushButton(self.layoutWidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Maximum, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.btn_addMember.sizePolicy().hasHeightForWidth())
        self.btn_addMember.setSizePolicy(sizePolicy)
        self.btn_addMember.setDefault(False)
        self.btn_addMember.setFlat(False)
        self.btn_addMember.setObjectName("btn_addMember")
        self.horizontalLayout.addWidget(self.btn_addMember)
        ...
        self.btn_removeMember = QtWidgets.QPushButton(self.layoutWidget)
        self.btn_removeMember.setObjectName("btn_removeMember")
        self.verticalLayout.addWidget(self.btn_removeMember)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btn_addMember.setText(_translate("MainWindow", "Add"))
        self.btn_sendEmail.setText(_translate("MainWindow", "Send Email"))
        self.btn_removeMember.setText(_translate("MainWindow", "Remove Member"))
