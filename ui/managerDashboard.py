...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.btn_pendingApps = QtWidgets.QPushButton(self.sidebar)
        font = QtGui.QFont()
        font.setPointSize(10)
        self.btn_pendingApps.setFont(font)
        self.btn_pendingApps.setObjectName("btn_pendingApps")
        self.vLayout_managerDashboard.addWidget(self.btn_pendingApps)
        ...
        self.dashboardContent.setGeometry(QtCore.QRect(240, 10, 791, 641))
        ...
        self.gridLayout = QtWidgets.QGridLayout(self.dashboardContent)
        ...
        self.gridLayout.addWidget(self.label_greeting, 0, 0, 1, 1)
        self.vLayout_latestUpdates = QtWidgets.QVBoxLayout()
        self.vLayout_latestUpdates.setObjectName("vLayout_latestUpdates")
        self.label_latestUpdates = QtWidgets.QLabel(self.dashboardContent)
        font = QtGui.QFont()
        ...
        self.vLayout_latestUpdates.addWidget(self.label_latestUpdates)
        self.tbl_latestUpdates = QtWidgets.QTableView(self.dashboardContent)
        self.tbl_latestUpdates.setObjectName("tbl_latestUpdates")
        self.vLayout_latestUpdates.addWidget(self.tbl_latestUpdates)
        self.gridLayout.addLayout(self.vLayout_latestUpdates, 1, 0, 1, 1)
        self.vLayout_memberStats = QtWidgets.QVBoxLayout()
        self.vLayout_memberStats.setObjectName("vLayout_memberStats")
        self.label_memberStats = QtWidgets.QLabel(self.dashboardContent)
        font = QtGui.QFont()
        font.setPointSize(18)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.label_recentApplications = QtWidgets.QLabel(self.dashboardContent)
        font = QtGui.QFont()
        font.setPointSize(18)
        font.setBold(True)
        font.setWeight(75)
        self.label_recentApplications.setFont(font)
        self.label_recentApplications.setObjectName("label_recentApplications")
        self.vLayout_recentApplications.addWidget(self.label_recentApplications)
        self.tbl_recentApplications = QtWidgets.QTableView(self.dashboardContent)
        self.tbl_recentApplications.setObjectName("tbl_recentApplications")
        self.vLayout_recentApplications.addWidget(self.tbl_recentApplications)
        self.gridLayout.addLayout(self.vLayout_recentApplications, 2, 0, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_greeting.setText(_translate("MainWindow", "Good afternoon!"))
        ...
        self.label_recentApplications.setText(_translate("MainWindow", "Recent Applications"))
